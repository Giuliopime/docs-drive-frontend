<template>
  <div class="relative flex flex-col items-center">
    ...
    <div v-if="filteredFiles.length > 0" class="w-full flex flex-col mt-4 border border-black" data-aos="zoom-in">
    ...
    <div v-else class="subtitle mt-8" data-aos="zoom-in">
  ...
  head: {
    ...
    meta: [
      ...
      },
      {
        hid: 'description',
        name: 'description',
        content: 'Visualizza e scarica i tuoi file dall\'area personale.'
      },
      {
        hid: 'og:description',
